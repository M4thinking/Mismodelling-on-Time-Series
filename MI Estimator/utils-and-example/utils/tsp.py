...
"""
from util_functions import add_tsp_path

import numpy as np
import os

# Path for the TSP shared object
# tsp_path: str = os.path.join(os.path.dirname(p=__file__), "/media/sebag/Disco Externo/Drive-Seba/UChile/10mo semestre/Teoria de la Información/Mismodelling-on-Time-Series/TSP-IT/src/build")
tsp_path: str = "/media/sebag/Disco Externo/Drive-Seba/UChile/10mo semestre/Teoria de la Información/Mismodelling-on-Time-Series/TSP-IT/src/build"
add_tsp_path(tsp_path=tsp_path)

# Import of the shared object
from TSP import TSP as TSP_so
...
class TSP:
    ...
    def __init__(self, l_bn: float = 0.167, w_bn: float = 5e-2, lambda_factor: float = 2.3e-5) -> None:
        ...
        self.tsp_so: TSP_so = TSP_so(l_bn, w_bn, lambda_factor)
